...
const { username, password, remember, authConfig, loadingConfig, logoUrl, messageLogin, validate, loginWithGoogle } = useLogin();
</script>
        ...
        <div class="flex flex-column align-items-center justify-content-center">
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full surface-card py-8 px-5 sm:px-8" style="border-radius: 53px">
                    ...
                    <div class="mt-4">
                        <Button label="Entrar com Google" icon="pi pi-google" class="w-full p-3 text-xl mb-4" :loading="loadingConfig" @click="loginWithGoogle()" />
                        ...
                        <Message v-if="authConfig?.local_instance_configured" severity="info" class="mt-3 mb-0">Instância local já configurada. Use o SSO corporativo para acessar.</Message>
                    </div>
                </div>
            </div>
        </div>
